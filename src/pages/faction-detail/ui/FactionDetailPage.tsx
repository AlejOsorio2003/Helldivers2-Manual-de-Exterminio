...
// Always returns exactly 5 slots so the bar never changes width
...
export default function FactionDetailPage({ factionId, onBack }: Props) {
  ...
  return (
    <div className="min-h-screen flex flex-col animate-fade-up">
      ...
      {/* Back button — always visible below header, far left */}
      ...
      {/* Pagination — anchored above footer, always 7 slots, centered */}
      <PaginationBar
        total={total}
        current={currentPage}
        color={color}
